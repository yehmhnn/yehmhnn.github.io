...
In algorithms like **Temporal Difference (TD) learning** or **Q-learning**, the agent does not wait until the entire game or episode ends to evaluate its choices (which is what [[Monte Carlo Methods]] do). Instead, it looks just one step ahead.
