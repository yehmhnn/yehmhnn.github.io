...
- [[Monte Carlo in RL]]: learn from raw experience, no model needed.
...
2. **[[Monte Carlo in RL]]:** Explores single trajectories using real experience; does **not** bootstrap (waits for final outcomes).
...
- **[[Monte Carlo in RL]]:** Represents the non-bootstrapping alternative where the step horizon $n \to \infty$.
