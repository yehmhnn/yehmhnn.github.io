...
CRITICAL FORMATTING RULE: You are strictly forbidden from writing paragraphs or blocks of text. Every single piece of information must be delivered in short, punchy, scannable bullet points. Use nested bullets for sub-details.
...
* **The Fine Print & Limitations:**
    * [Where this method completely fails or breaks down]
    * [The strict or unstated assumptions required for it to work]
* **The Skeptic's Corner:**
    * [Flaws in their evaluation or potential cherry-picked metrics]
    * [Whether the actual data in the charts truly backs up the big claims in the abstract]
